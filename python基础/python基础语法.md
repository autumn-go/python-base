...
```
    ...
    <ipython-input-22-61dcc9d45022> in <module>
         26 # 查询的值不可以超出列表个数，否则报错。
         27 # 但是利用insert()插入时可以，超出范围的值会直接被插入到列表最末
    ---> 28 li[4]  # Raises an IndexError
...
```
    ...
    <ipython-input-35-10a1078f3a8f> in <module>
         89     # 删除age
         90 del i.age
    ---> 91 i.age  # => raises an AttributeError
    

    <ipython-input-35-10a1078f3a8f> in age(self)
         50     @property
         51     def age(self):
    ---> 52         return self._age
         53 
         54         # This allows the property to be set
